...
- [ai-spiritual-companion](https://github.com/RoxyAPI/ai-spiritual-companion): the second flagship, an AI companion that remembers every user. pgvector semantic recall, the full reading history, Supabase accounts with row level security, and a natal chart computed once and kept, grounded over Remote MCP with compact responses. The memory layer lives in the operator stack, which makes it the natural premium feature to build plans on.
